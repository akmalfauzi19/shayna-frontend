        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="cart-table" v-if="keranjangUser.length > 0">
                                <table>
                                    <thead>
                                        <tr>
                                            <th>Image</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="keranjang in keranjangUser" :key="keranjang.id">
                                            ...
                                            <td class="p-price first-row">{{ keranjang.price | currency }}</td>
                        ...
                        <div class="col-lg-12">
                            <div class="proceed-checkout text-left">
                                <ul>
                                    ...
                                    <li class="subtotal mt-3">Subtotal <span>{{ totalHarga | currency }}</span></li>
                                    <li class="subtotal mt-3">Pajak <span>10% = {{ tambahPajak | currency }}</span></li>
                                    <li class="subtotal mt-3">Total Biaya <span>{{ totalBiaya | currency }}</span></li>
                                    <li class="subtotal mt-3">Bank Transfer <span>Mandiri</span></li>
                                    <li class="subtotal mt-3">No. Rekening <span>2208 1996 1403</span></li>
                                    <li class="subtotal mt-3">Nama Penerima <span>Hafizh Akmal Fauzi</span></li>
                                </ul>
...
export default {
    ...
    methods: {
        ...
        checkout() {
            ...
            Swal.fire({
                ...
                text: "Anda tidak bisa membatalkan pesanan ini!",
                icon: 'warning',
    ...
    computed: {
        ...
        totalBiaya() {
            return this.tambahPajak + this.totalHarga;
        }
    },
}
</script>
